...
public class MXHActivity extends AppCompatActivity {
    TextView txtImage;
    ImageView imgShare;
    Bitmap bitmap;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mxhactivity);
    ...
    private Uri getmageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            outputStream.flush();
            outputStream.close();
            uri = FileProvider.getUriForFile(this, "com.dinhnt.cp1730x.fileprovider", file);
        } catch (Exception e) {
